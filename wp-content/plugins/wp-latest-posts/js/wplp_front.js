jQuery(document).ready(function ($) {
  $('[id^="wplp_widget_"].default').each(function () {
    ...
    if (widget_params !== undefined) {
      ...
      if (
        typeof widget_params.space_between != "undefined" &&
        !isNaN(widget_params.space_between)
      ) {
      ...
      if (
        typeof widget_params.addon_enable != "undefined" &&
        widget_params.addon_enable == "1"
      ) {
        if (
          typeof widget_params.slidespeed != "undefined" &&
          !isNaN(widget_params.slidespeed)
        ) {
      ...
      if (
        typeof widget_params.autoanimate != "undefined" &&
        widget_params.autoanimate == "1" &&
        typeof widget_params.slideshowspeed != "undefined" &&
        !isNaN(widget_params.slideshowspeed)
      ) {
      ...
      if (
        typeof widget_params.addon_enable != "undefined" &&
        widget_params.addon_enable == "1" &&
        typeof mySwiperParams.autoplay != "undefined"
      ) {
        var check_pauseaction = 0;
        if (
          typeof widget_params.pausehover != "undefined" &&
          widget_params.pausehover == "1"
        ) {
      ...
      if (wplp_swiper.hasClass("swiper-vertical")) {
        var height = wplp_swiper
          .find(".swiper-slide .thumbnail:first")
          .height();
      ...
      if (wplp_swiper.hasClass("swiper-horizontal")) {
        if ($(window).width() <= 767) {
          $(
            "#wplp_widget_" +
              widget_params.id +
              " .wplp_listposts.swiper-wrapper"
          ).addClass("swiper-slide-mb");
        } else {
          $(
            "#wplp_widget_" +
              widget_params.id +
              " .wplp_listposts.swiper-wrapper"
          ).removeClass("swiper-slide-mb");
        }
      }
    }
  });
...
(function ($) {
  $.fn.wplp_swiper = function (options, settings) {
    var swiper = new Swiper(
      `#wplp_widget_${settings.id}.wplp_widget_default`,
      options
    );
    ...
    console.log(options);
    if (
      typeof settings.addon_enable != "undefined" &&
      settings.addon_enable == "1" &&
      typeof options.autoplay != "undefined"
    ) {
      var check_pauseaction = 0;
      if (
        typeof settings.pausehover != "undefined" &&
        settings.pausehover == "1"
      ) {
        $(".wplp-swiper").mouseenter(function () {
